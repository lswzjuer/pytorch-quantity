...
import .kitti.calibration as calibration
import .kitti.utils as kitti_utils
import .kitti.roipool3d_utils as roipool3d_utils
...
class KittiRCNNDataset(KittiDataset):
    def __init__(self, root_dir, cfg=None, npoints=16384, split='train', classes='Car', mode='TRAIN', random_select=True,
