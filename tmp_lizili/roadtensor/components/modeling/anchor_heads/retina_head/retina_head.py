...
class RetinaNetHeadHead(torch.nn.Module):
    """
    ...
    def __init__(self, cfg, in_channels):
        ...
        """
        super(RetinaNetHeadHead, self).__init__()
...
@registry.ANCHOR_HEADS.register("RetinaNetHead")
class RetinaNetHead(torch.nn.Module):
    """
    Head module for RetinaNet computation. Takes feature maps from the backbone and
    ...
    def __init__(self, cfg, in_channels):
        ...
        head = RetinaNetHeadHead(cfg, in_channels)
    ...
    def forward(self, images, features, targets=None):
        ...
        # export box_cls and box_reg
        if self.exporting:
            box_cls = [box_cl.sigmoid() for box_cl in box_cls]
