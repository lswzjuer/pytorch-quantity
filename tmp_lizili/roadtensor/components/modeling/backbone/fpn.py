...
class FPN(nn.Module):
    ...
    def __init__(
        self, in_channels_list, out_channels, conv_block, top_blocks=None, upsample_last_layer=True
    ):
        """
        Arguments:
        ...
        self.upsample_last_layer = upsample_last_layer
    ...
    def forward(self, x):
        ...
        for idx, (feature, inner_block, layer_block) in enumerate(zip(
            ...
            if not inner_block:
                continue
            if idx == 0 and not self.upsample_last_layer:
