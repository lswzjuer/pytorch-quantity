...
from roadtensor.components.modeling.anchor_heads.rpn_head import rpn_head
from roadtensor.components.modeling import poolers
...
@registry.ANCHOR_HEADS.register("FBNet.rpn_head")
def add_rpn_head(cfg, in_channels, num_anchors):
    ...
    rpn_regressor = rpn_head.RPNHeadConvRegressor(
