...
from roadtensor.common.utils.env import setup_environment  # noqa F401 isort:skip
...
from roadtensor.components.data import make_data_loader
from roadtensor.common.solver import make_lr_scheduler
from roadtensor.common.solver import make_optimizer
...
from roadtensor.common.utils.comm import synchronize, get_rank
...
from roadtensor.components.engine.trainer import do_train
from roadtensor.components.engine.inference import inference
...
def main():
    ...
    logger = setup_logger("roadtensor", cfg.LOG_DIR, get_rank())
