...
/**
 * @namespace roadstar::canbus
 * @brief roadstar::canbus
 */
namespace roadstar {
namespace common {
namespace canbus {
...
class Byte {
 public:
  ...
  /**
   * @brief Transform an integer with the size of 2 bytes to its hexadecimal
   *        represented by a string.
   * @param value The target integer to transform.
   * @return Hexadecimal representing the target integer.
   */
  static std::string byte_to_hex(const uint16_t value);
  ...
  /**
   * @brief Transform an integer with the size of 8 bytes to its hexadecimal
   *        represented by a string.
   * @param value The target integer to transform.
   * @return Hexadecimal representing the target integer.
   */
  static std::string byte_to_hex(const uint64_t value);
