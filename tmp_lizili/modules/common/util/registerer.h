...
#ifndef MODULES_COMMON_UTIL_REGISTERER_H_
#define MODULES_COMMON_UTIL_REGISTERER_H_
...
#define REGISTER_CLASS(clazz, name)                                           \
  class ObjectFactory##name : public roadstar::common::ObjectFactory {        \
   public:                                                                    \
...
#endif  // MODULES_COMMON_UTIL_REGISTERER_H_
