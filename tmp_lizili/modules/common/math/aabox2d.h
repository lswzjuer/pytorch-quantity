...
class AABox2d {
 public:
  ...
  /**
   * @brief Computes overlap between another box.
   *
   * @param box Another box
   * @param is_union Whether union area is sum area
   */
  double GetOverlap(const AABox2d &box, const bool &is_union = true) const;
