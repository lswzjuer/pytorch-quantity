...
# Specific for lidar_fusion
_C.INPUT.AREA_EXTENTS = ((-40, 68), (-40, 40), (-0.2, 2.8))
_C.INPUT.SELF_CAR_EXTENTS = ((-6.0, 2.0), (-2.1, 2.1))
_C.INPUT.VOXEL_SIZE = 0.1
_C.INPUT.GROUND_PLANE = 0
_C.INPUT.DENSITY_THRESHOLD = 1
_C.INPUT.DENSITY_NORMAL_VALUE = 8
_C.INPUT.NUM_SLICES = 5
_C.INPUT.USE_COORD = True
...
# Specific for LidarFusion
_C.MODEL.RETINANET.ROTATIONS = (0, np.pi / 2.0)
...
# Export
# ---------------------------------------------------------------------------- #
# img width and height for generating tensorRT engine
_C.EXPORT = CN()
_C.EXPORT.IMG_HEIGHT = 1280
_C.EXPORT.IMG_WIDTH = 1280
_C.EXPORT.IMG_CHANNEL = 3

# img width and height for generating tensorRT engine
_C.EXPORT.BEV_HEIGHT = 1088
_C.EXPORT.BEV_WIDTH = 1088
_C.EXPORT.BEV_CHANNEL = 800

# max batch size to use for TensorRT engine
_C.EXPORT.BATCH = 1

# export in full instead of half precision
_C.EXPORT.FULL_PRECISION = False
# calibrate model and export in int8 precision
_C.EXPORT.INT8 = False

# number of batches to use for int8 calibration
_C.EXPORT.CALIBRATION_BATCHES = 10
# path to calibration images to use for int8 calibration
_C.EXPORT.CALIBRATION_IMAGES = ""
# path to calibration pointclouds to use for int8 calibration
_C.EXPORT.CALIBRATION_POINTCLOUDS = ""
# path of existing calibration table to load from, or name of new calibration table
_C.EXPORT.CALIBRATION_TABLE = ""

_C.EXPORT.ONNX_ONLY = True
_C.EXPORT.TENSORRT = False
_C.EXPORT.TVM = False
_C.EXPORT.CAFFE2 = False
_C.EXPORT.TORCH_SCRIPT = False
